...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        try {
            user = new User(signUpRequest.getNom(), signUpRequest.getPrenom(), signUpRequest.getUsername(),
                    ...
                    signUpRequest.getcategorieClient(),signUpRequest.getProfession() ,signUpRequest.getSolde(),
                    signUpRequest.getFriendList() ,signUpRequest.getRequestList());
  ...
  roles.add(userRole); } 
        ...
        user.setRoles(roles); user.setFriendlist("+");  user.setRequestlist("+");	
